...
My final act in the spring level was adjusting the camera angle on a couple of the  BP_CameraChange just to make sure that the player wasn't disappearing off screen when they entered the collision volume to activate the camera change, no evidence for this and they were only minor QoL adjustments. This means nothing now because Dylan and Esme have made or corrected all the things that went missing and changes made to the jumping platforms additions of SAP dispensers and significant overhauling of the change camera angles.
...
When we initially started this project and had access to the build through GitHub I was looking forward to the challenge. When I was assigned the role of a QA, I had to ask for qualification of what that job role actually entailed. Given my eye for detail and perfectionist tendencies, which was noticed by my senior lecturer, he thought this was the ideal fit for me as did I (after a little convincing). Admittedly I still have a lot to learn when it comes to Unreal Engine and probably more to learn when it comes to communicating with people that I am unfamiliar with. I guess deep down I may have been a little concerned that I might not be able to explain myself within the confines of Unreal Engine and the language that I would have to use. Studying at University is a learning process from start to finish, as is life.

My first task was easy, play through the initial game and see if I can find any issues with it. No problem, I found 2 straight off the bat and fixed them…3 times (I don't know if the original level made it to the end). It was a GitHub thing no biggie. Well I hope I know more about GitHub now than I did at the start of this, hopefully that will be the same for everyone. But I think it was GitHub and the lack of activity in the main branch in regards to 0 pushes of levels with them all being squirrelled away on X number of branches by the end of the project that really started to get to me. Just a couple of blockouts would have been nice to start with, but whatever, they're game designers, they know what they're doing...right? (Supplement meme French accent)... Six weeks later! Data dump...one week before deadline Ho Lee Shhh. Interesting fact, the origin of deadline comes from a line that was drawn within or around a prison and anyone (prisoners I assume) who crossed it was shot dead, circa. 1860s.

I should have communicated better to get access to the levels sooner but I really didn't feel like talking. Didn't feel like I belonged. Did not want to be there. Anyway on a lighter note most of the minor changes that I made to the levels when I got into them, mysteriously altered or disappeared, some were either not properly pushed by GitHub, I honestly thought I was getting the hang of it, or somehow altered by Unreal Engine or something else. 

I think we all had high hopes at the start of this project. Ideally there needs to be better lines of communication on everybody's part. Better organisation/compartmentalising of assets in levels. Would like to have seen comment boxes on everything, at least it would give someone a starting reference to figure out what the purpose of the blueprint is. More decisiveness, because the Game Design Document I read barely resembles this game, where did the AI go? I did not include a build of the game in my submission because I could not build it which probably means I don't know how to do it. If there is a build out there it should be counted as part of everybody's submission, not just those that got it to build, this was a team project after all.
